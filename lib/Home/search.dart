              ...
              child: Row(
                ...
                child: GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    // debugPrint('Email: ${users[index]['email']}');
                    // debugPrint('Full Name: ${users[index]['full_name']}');
                    // debugPrint('department: ${users[index]['department']}');
                    // debugPrint('Date Of Birth: ${users[index]['date_of_birth']}');
                    // debugPrint('Employee Number: ${users[index]['emp_number']}');
                    // debugPrint('salary: ${users[index]['salary']}');
                    // debugPrint('');
                    ...
                    return Card(
                      ...
                      child: Center(child: ListTile(
                        ...
                        leading: CircleAvatar(
                          ...
                          NetworkImage(
                              Gravatar(users[index]['email']).imageUrl()) :
                          NetworkImage(users[index]['imageUrl']),
                        ),
                        title: Text(users[index]['full_name']),
                        subtitle: (users[index]['updatedEmail'] ==
                            null)
                            ? Text(
              ...
              child: ListView(
                children: <Widget>[
                  ...
                  const Padding(
                      ...
                      child: Text('Search By...', style: TextStyle(fontSize: 20.0,
                  ...
                  ListTile(
                    title: const Text(
                        'Department', style: TextStyle(color: Colors.white)),
                    leading: Radio<SingingCharacter>(
                  ...
                  ListTile(
                    title: const Text(
                        'Employee Number', style: TextStyle(color: Colors.white)),
                    leading: Radio<SingingCharacter>(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            title: ListTile(
              ...
              title: Text(users[index]['full_name']),
              subtitle: (users[index]['updatedEmail'] == null)? Text('Email: ${users[index]['email']}'):Text('Email: ${users[index]['updatedEmail']}'),
            ),
            content: SizedBox(
              // height: 200.0,
              width: 300.0,
